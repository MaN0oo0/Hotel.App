...
$(function() {
		...
		var dataset = [
			...
			{ label: "Male mean", data: males["mean"], lines: { show: true }, color: "rgb(159, 120, 255)" },
			{ id: "m15%", data: males["15%"], lines: { show: true, lineWidth: 0, fill: false }, color: "rgb(159, 120, 255)" },
			{ id: "m25%", data: males["25%"], lines: { show: true, lineWidth: 0, fill: 0.2 }, color: "rgb(159, 120, 255)", fillBetween: "m15%" },
			{ id: "m50%", data: males["50%"], lines: { show: true, lineWidth: 0.5, fill: 0.4, shadowSize: 0 }, color: "rgb(159, 120, 255)", fillBetween: "m25%" },
			{ id: "m75%", data: males["75%"], lines: { show: true, lineWidth: 0, fill: 0.4 }, color: "rgb(159, 120, 255)", fillBetween: "m50%" },
			{ id: "m85%", data: males["85%"], lines: { show: true, lineWidth: 0, fill: 0.2 }, color: "rgb(159, 120, 255", fillBetween: "m75%" }
		];
	...
	$(function() {
		...
		$("#example-1").click(function() {
			...
			$.plot(placeholder, data, {
				...
				colors: ['#4a32d4', '#f72d66', '#f7be2d', '#2dcbf7', '#2df7be'],
		...
		$("#example-4").click(function() {
			...
			$.plot(placeholder, data, {
				...
				colors: ['#4a32d4', '#f72d66', '#f7be2d', '#2dcbf7', '#64E572'],
				legend: {
					show: false
				}
			});
