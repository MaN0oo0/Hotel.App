...
$(function(e) {
	...
	Highcharts.chart('highchart3', {
		...
		series: [{
			...
			colors: ['#4a32d4', '#f72d66', '#f7be2d', '#2df7be', '#2dcbf7', '#f7592d', '#66f72d', '#592df7']
		}]
	});
	/* ---hightchart4----*/
	...
	Highcharts.chart('highchart5', {
		...
		colors: ['#ecb403', '#64E572', '#24CBE5', '#564ec1', '#04cad0'],
		credits: {
			enabled: false
		},
		series: [{
	...
	Highcharts.chart('highchart6', {
		...
		colors: ['#ecb403', '#24CBE5', '#f72d66' , '#4a32d4', '#ff5c75' ],
		responsive: {
			rules: [{
				condition: {
					maxWidth: 500
